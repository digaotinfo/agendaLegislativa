    ...
    <div class="col s12">
         <h3 class="titulo-pagina">
            Tipo
 			...
 			if ($userAdmin == 1){
 				?>
	             <a href="<?=$this->Html->url(array('controller' => 'plTypes', 'action' => 'add'))?>" class="btn-floating right  green darken-3 tooltipped" data-position="left" data-delay="50" data-tooltip="Adicionar um novo tipo"><i class="material-icons">add</i></a>
				 <?php
			 }
			?>
         </h3>
						   ...
						   if ($userAdmin == 1){
								...
								echo $this->Form->postLink(
									...
									array(
										...
										$registro[$model]['id']),
									array(
										'confirm' => 'Tem certeza que deseja excluir este Tipo?',
										'class' => 'btn-floating red tooltipped margin-right-4',
										'data-position' => 'bottom',
										'data-delay' => 50,
										'data-tooltip' => "Apagar Tipo",
										'escape'=>false
									)
								);
