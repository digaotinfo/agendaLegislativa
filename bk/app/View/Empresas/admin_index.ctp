    ...
    <div class="col s12">
         <h3 class="titulo-pagina">
            Empresas
 			...
 			if ($userAdmin == 1){
 				?>
	             <a href="<?=$this->Html->url(array('controller' => 'empresas', 'action' => 'add'))?>" class="btn-floating right  green darken-3 tooltipped" data-position="left" data-delay="50" data-tooltip="Adicionar uma nova empresa"><i class="material-icons">add</i></a>
				 <?php
			 }
			?>
         </h3>
