    ...
    <div class="col s12">
         <h3 class="titulo-pagina">
            Temas
 			...
 			if ($userAdmin == 1){
 				?>
	             <a href="<?=$this->Html->url(array('controller' => 'Temas', 'action' => 'add'))?>" class="btn-floating right  green darken-3 tooltipped" data-position="left" data-delay="50" data-tooltip="Adicionar um novo tema"><i class="material-icons">add</i></a>
				 <?php
			 }
			?>
         </h3>
...
<div class="row padding-top-20 arquivos">
    <div class="col s12">
        ...
        <table class="striped">
            <thead>
                    <th data-field="nome" class="nome-short"><?=$this->Paginator->sort($model.'.tema_name', 'Tema');?></th>
            ...
            <tbody>
                <?php foreach($registros as $registro): ?>
                    <tr>
                        <td><?=$registro[$model]['tema_name'];?></td>
                        <td>
                            <?php
                                $icon = '';
						   ...
						   if ($userAdmin == 1){
								...
								echo $this->Form->postLink(
									...
									array(
										...
										$registro[$model]['id']),
									array(
										'confirm' => 'Tem certeza que deseja excluir este Tema?',
										'class' => 'btn-floating red tooltipped',
										'data-position' => 'bottom',
										'data-delay' => 50,
										'data-tooltip' => "Apagar Tema",
										'escape'=>false
									)
								);
