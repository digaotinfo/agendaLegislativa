...
class TemasController extends AppController{
		...
		if ($this->request->is('post')){
			...
			if($this->$model->validates()){
	            ...
	            if ($this->$model->save($this->request->data)){
		            ...
		            $this->Session->setFlash('Tema adicionado com sucesso!');
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			...
			if($this->$model->validates()){
				...
				if($this->$model->save($this->request->data)){
					...
					// Inserindo um alerta de sucesso na sessão ativa para ser mostrado ao usuário
	            	$this->Session->setFlash('Tema alterado com sucesso!');
    ...
    function admin_delete($id){
		...
		if ($this->$model->delete($id)) {
			...
			// Inserindo um alerta de sucesso na sessão ativa para ser mostrado ao usuário
			$this->Session->setFlash('Tema excluído com sucesso!');
