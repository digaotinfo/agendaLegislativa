    ...
    <div class="col s12">
         <h3 class="titulo-pagina">
            Autores e Relatores
 			...
 			if ($userAdmin == 1){
 				?>
	             <a href="<?=$this->Html->url(array('controller' => 'autorRelators', 'action' => 'add'))?>" class="btn-floating right  green darken-3 tooltipped" data-position="left" data-delay="50" data-tooltip="Adicionar um novo Autor/Relator"><i class="material-icons">add</i></a>
				 <?php
			 }
			?>
         </h3>
		<?php
			...
			echo $this->Html->Link(
				...
				array(
					'controller' => 'autorRelators',
					'action' => 'admin_import'
				),
				array(
					'class' => 'btn-floating green darken-1 tooltipped margin-right-4 right hide',
					'data-position' => 'bottom',
					'data-delay' => 50,
					'data-tooltip' => "Importar Autor/Relator",
					'escape'=>false
				));
		?>
     </div>
                    ...
                    <div class="input-field">
						<?php
							echo $this->Form->input('search', array(
								...
								'class'	=> 'search',
								'id'	=> 'search',
								'placeholder'	=> 'Buscar Autor/Relator',
						   ...
						   if ($userAdmin == 1){
								...
								echo $this->Html->Link(
									...
									array(
										...
										'data-position' => 'bottom',
										'data-delay' => 50,
										'data-tooltip' => "Editar Autor/Relator",
										'escape'=>false
									)
								);
								...
								echo $this->Form->postLink(
									...
									array(
										...
										$registro[$model]['id']),
									array(
										'confirm' => 'Tem certeza que deseja excluir este Autor/Relator?',
										'class' => 'btn-floating red tooltipped',
										'data-position' => 'bottom',
										'data-delay' => 50,
										'data-tooltip' => "Apagar Autor/Relator",
										'escape'=>false
									)
								);
