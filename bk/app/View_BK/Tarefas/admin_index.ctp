    ...
    <div class="col s12">
         <h3 class="titulo-pagina">
            Tarefas
 			...
 			if ($userAdmin == 1){
 				?>
	            <!-- <a href="" class="btn-floating right  green darken-3 tooltipped" data-position="left" data-delay="50" data-tooltip="Adicionar uma nova tarefa"><i class="material-icons">add</i></a> -->
				<?php
			 }
			?>
         </h3>
...
<div class="row padding-top-20 arquivos">
    <div class="col s12">
        ...
        <table class="striped">
            <thead>
                    <th data-field="titulo" class="nome-short"><?=$this->Paginator->sort($model.'.titulo', 'Tarefa');?></th>
                    <th data-field="ativo" class="arquivo-short"><?=$this->Paginator->sort($model.'.ativo', 'Ativo');?></th>
                    <th data-field="realizado" class="arquivo-short"><?=$this->Paginator->sort($model.'.realizado', 'Realizado');?></th>
